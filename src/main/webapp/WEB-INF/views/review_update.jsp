            	...
            	<div class="listmain">
    				...
    				<form action = "do_update" method = "post">
   						<table class="inserttable">
      						<tr>
         						<td><input type="text" class="insertinput" value = "${result.review_title}" name="review_title"></td>
      						</tr>
      						<tr>
         						<td><textarea class="insertaddr" name="review_content">${result.review_content}</textarea></td>
      						</tr>
   						</table>
