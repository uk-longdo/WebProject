...
<body>
	<div id="wrap">
	    ...
	    <div id="content">
            ...
            <div id="boardlist">
            	<div class="listmain">
            		<h1 id="insertheder">공지 작성</h1>
    				<form action="doupdate_notice" method="post">
   						<table class="inserttable">
      						<tr>
         						<td><input type="text" class="insertinput" name="notice_title" value = "${result.notice_title}"></td>
      						</tr>
      						<tr>
         						<td><textarea class="insertaddr" name="notice_content">${result.notice_content}</textarea></td>
      						</tr>
   						</table>
   						<input type="hidden" value = "${result.notice_idx}" name="notice_idx">
   						<div class="buttons">
	        				<input class="backbutton" type="button" value="취소" onclick = "location.href = 'notice_list'">
	        				<input class="insertbutton" type="submit" value="공지수정">  
	      				</div>
   					</form>
