...
<body>
	<div id="wrap">
	    ...
	    <div id="content">
            ...
            <div id="boardlist">
            	<div class="listmain">
            		<h1 id="insertheder">리뷰 작성</h1>
    				<form action="qa_upadte"  method = "post">
   						<table class="inserttable">
      						<tr>
         						<td><input type="text" class="insertinput" value="${res.qa_title}" name="qa_title" ></td>
      						</tr>
      						<tr>
         						<td><textarea class="insertaddr" name="qa_content">${res.qa_content}</textarea></td>
      						</tr>
   						</table>
   						<input type="hidden" value = "${res.qa_idx}" name="qa_idx">
   						<div class="buttons">
	        				<input class="backbutton" type="button" value="취소" onclick = "location.href = 'Qaboard_list'">
	        				<input class="insertbutton" type="submit" value="글수정">  
	      				</div>
   					</form>
