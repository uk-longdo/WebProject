...
<body>
	<div id="wrap">
	    ...
	    <div id="content">
            ...
            <div id="boardlist">
            	<div class="listmain">
            		<h1 id="insertheder">문의 작성</h1>
    				<form action="board_insert"  method="post">
   						<table class="inserttable">
   							<tr>
   								<td>
   									<select name="qa_sel" class="insertinput">
      						...
      						<tr>
         						<td><input type="text" class="insertinput" name="qa_title"  placeholder="제목을 입력하세요"></td>
      						</tr>
      						<tr>
         						<td><textarea class="insertaddr" name="qa_content"  placeholder="내용을 입력하세요"></textarea></td>
   						</table>
