	    ...
	    <div id="content">
            ...
            <div id="boardlist">
            	<div class="listmain">
    				...
    				<form action="do_notice" method="post">
   						<table class="inserttable">
      						<tr>
         						<td><input type="text" class="insertinput" name="notice_title" placeholder="제목을 입력하세요"></td>
      						</tr>
      						<tr>
         						<td><textarea class="insertaddr" name="notice_content" placeholder="내용을 입력하세요"></textarea></td>
      						</tr>
   						</table>
   						...
   						<div class="buttons">
	        				...
	        				<input class="insertbutton" type="submit" value="글쓰기">  
	      				</div>
   					</form>
